...
stk=0
dot_cho = [[0 for col_e in range(6)] for row_e in range(2)]
dot_joong = [[0 for col_m in range(6)] for row_m in range(2)]
dot_jong = [[0 for col_f in range(6)] for row_f in range(2)] 
